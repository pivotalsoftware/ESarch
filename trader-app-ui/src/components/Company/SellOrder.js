...
export default class SellOrder extends Component {
  ...
  onFormSubmit(event) {
    event.preventDefault();
    if (this.props.sellOrderHandler) {
      this.props.sellOrderHandler(this.state.priceToTrade, this.state.amountToTrade);
    }
  }
...
dollars reserved
                ...
                <h4 className="company-transaction-title my-3">Enter shares to sell and for how much</h4>
