...
import io.pivotal.refarch.cqrs.trader.coreapi.portfolio.cash.WithdrawCashCommand;
...
import io.pivotal.refarch.cqrs.trader.coreapi.portfolio.stock.ItemToReserveNotAvailableInPortfolioEvent;
