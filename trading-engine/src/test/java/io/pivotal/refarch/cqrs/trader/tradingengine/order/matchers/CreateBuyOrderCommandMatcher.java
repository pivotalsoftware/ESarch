...
package io.pivotal.refarch.cqrs.trader.tradingengine.order.matchers;
...
public class CreateBuyOrderCommandMatcher extends BaseMatcher<CommandMessage<?>> {
    ...
    public static Matcher<CommandMessage<?>> newInstance(PortfolioId portfolioId, OrderBookId orderBookId, long totalItems,
                                      long pricePerItem) {
